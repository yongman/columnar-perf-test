...
SELECT
    ...
    DATE_ADD(DATE_ADD(TIMESTAMP('2026-03-01 00:00:00'), INTERVAL 2 DAY), INTERVAL ((4000000 + seq) % 86400) SECOND) AS stat_time,
    ...
    DATE_ADD(DATE_ADD(TIMESTAMP('2026-03-01 00:01:00'), INTERVAL 2 DAY), INTERVAL ((4000000 + seq) % 86400) SECOND) AS updated_at
FROM bench_seq_1m
WHERE seq < 1000000;
...
SELECT
    ...
    DATE_ADD(DATE_ADD(TIMESTAMP('2026-03-01 00:00:00'), INTERVAL 2 DAY), INTERVAL ((5000000 + seq) % 86400) SECOND) AS stat_time,
    ...
    DATE_ADD(DATE_ADD(TIMESTAMP('2026-03-01 00:01:00'), INTERVAL 2 DAY), INTERVAL ((5000000 + seq) % 86400) SECOND) AS updated_at
FROM bench_seq_1m
WHERE seq < 1000000;
